...
import level3 from './scene/Level3.js';
...
window.onload = function () {
    var gameConfig = {
        ...
        scene: [bootGame, level1, level2,level3, nextLevel, finish, play, waitingOpponent, menu, soundAdjustment, controlsConfiguration],
        physics: {
            default: "arcade",
            arcade: {
                debug: false
